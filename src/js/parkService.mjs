...
export const parkInfoLinks = [
  {
    ...
    alt: park.images?.[2]?.altText || park.images?.[2]?.title || park.fullName,
    description:
  ...
  },
  {
    ...
    alt: park.images?.[3]?.altText || park.images?.[3]?.title || park.fullName,
  ...
  },
  {
    ...
    alt: park.images?.[9]?.altText || park.images?.[9]?.title || park.fullName,
